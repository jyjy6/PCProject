...
public class AdminProductController {
    ...
    public String createProduct(@ModelAttribute ProductDTO productDTO, RedirectAttributes reAttr) {
    ...
    public String updateProductForm(@RequestParam("seq") int seq, Model model) {
        productService.getProductBySeq(seq).ifPresent(product -> model.addAttribute("product", product));
        return "kim/adminPage/product/ProductModify";
    }

    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping("/ProductModify")
    public String updateProduct(@ModelAttribute ProductDTO productDTO, RedirectAttributes reAttr) {
    ...
    public String deleteProductForm(@RequestParam("seq") int seq, Model model) {
        model.addAttribute("product", productService.getProductBySeq(seq).orElse(null));
        return "kim/adminPage/product/ProductDelete";
    }

    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping("/ProductDelete")
    public String removeProduct(@RequestParam("seq") int seq, RedirectAttributes reAttr) {
